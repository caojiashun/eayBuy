...
<div id="header" class="wrap">
	...
	<div class="help">
	<a href="Cart" class="shopping" id="shoppingBag">购物车<c:out value="${sessionScope.cart.items.size()}" default="0"/>件
	</a>
	...
	<div class="navbar">
		<ul class="clearfix">
			<li class="current"><a href="${pageContext.request.contextPath}/index">首页</a></li>
			<li><a href="#">图书</a></li>
			<li><a href="#">百货</a></li>
			<li><a href="#">品牌</a></li>
			<li><a href="#">促销</a></li>
